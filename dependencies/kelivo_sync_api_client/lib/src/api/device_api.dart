...
class DeviceApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CommitDeviceRotationResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CommitDeviceRotationResponse>> commitDeviceRotation({
    required CommitDeviceRotationRequest commitDeviceRotationRequest,
    ...
    final _path = r'/api/device/rotation/commit';
    ...
    try {
      const _type = FullType(CommitDeviceRotationRequest);
    ...
    CommitDeviceRotationResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
                  rawResponse,
                  specifiedType: const FullType(CommitDeviceRotationResponse),
                )
                as CommitDeviceRotationResponse;
    } catch (error, stackTrace) {
      throw DioException(
    ...
    return Response<CommitDeviceRotationResponse>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetDeviceSecurityStateResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetDeviceSecurityStateResponse>> getDeviceSecurityState({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/device/security-state/get';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
    ...
    GetDeviceSecurityStateResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
                  rawResponse,
                  specifiedType: const FullType(GetDeviceSecurityStateResponse),
                )
                as GetDeviceSecurityStateResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<GetDeviceSecurityStateResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
