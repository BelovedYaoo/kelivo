...
class AttachmentApi {
  ...
  Future<Response<CompleteAttachmentUploadResponse>> completeAttachmentUpload({
    ...
    try {
      const _type = FullType(CompleteAttachmentUploadRequest);
    ...
    CompleteAttachmentUploadResponse? _responseData;
    ...
    return Response<CompleteAttachmentUploadResponse>(
      data: _responseData,
  ...
  Future<Response<DeleteAttachmentInfoResponse>> deleteAttachmentInfo({
    ...
    try {
      const _type = FullType(DeleteAttachmentInfoRequest);
      _bodyData = _serializers.serialize(
        deleteAttachmentInfoRequest,
        specifiedType: _type,
      );
    ...
    DeleteAttachmentInfoResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
                  rawResponse,
                  specifiedType: const FullType(DeleteAttachmentInfoResponse),
                )
                as DeleteAttachmentInfoResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<DeleteAttachmentInfoResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<GetAttachmentDownloadUrlResponse>> getAttachmentDownloadUrl({
    ...
    try {
      const _type = FullType(GetAttachmentDownloadUrlRequest);
      _bodyData = _serializers.serialize(
        getAttachmentDownloadUrlRequest,
        specifiedType: _type,
      );
    ...
    GetAttachmentDownloadUrlResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
                ...
                as GetAttachmentDownloadUrlResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<GetAttachmentDownloadUrlResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ListAttachmentInfoResponse>> listAttachmentInfo({
    ...
    try {
      const _type = FullType(ListAttachmentInfoRequest);
      _bodyData = _serializers.serialize(
        listAttachmentInfoRequest,
        specifiedType: _type,
      );
    ...
    ListAttachmentInfoResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
                  rawResponse,
                  specifiedType: const FullType(ListAttachmentInfoResponse),
                )
                as ListAttachmentInfoResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<ListAttachmentInfoResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<PrepareAttachmentUploadResponse>> prepareAttachmentUpload({
    ...
    try {
      const _type = FullType(PrepareAttachmentUploadRequest);
      _bodyData = _serializers.serialize(
        prepareAttachmentUploadRequest,
        specifiedType: _type,
      );
    ...
    PrepareAttachmentUploadResponse? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
                ...
                as PrepareAttachmentUploadResponse;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<PrepareAttachmentUploadResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
