...
part 'list_account_security_state_history_data.g.dart';
...
/// * [currentState]
@BuiltValue()
abstract class ListAccountSecurityStateHistoryData
    implements
        Built<
          ListAccountSecurityStateHistoryData,
  ...
  ListAccountSecurityStateHistoryData._();

  factory ListAccountSecurityStateHistoryData([
    void updates(ListAccountSecurityStateHistoryDataBuilder b),
  ]) = _$ListAccountSecurityStateHistoryData;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ListAccountSecurityStateHistoryDataBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ListAccountSecurityStateHistoryData> get serializer =>
      _$ListAccountSecurityStateHistoryDataSerializer();
}

class _$ListAccountSecurityStateHistoryDataSerializer
    implements PrimitiveSerializer<ListAccountSecurityStateHistoryData> {
  @override
  ...
  @override
  final String wireName = r'ListAccountSecurityStateHistoryData';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ListAccountSecurityStateHistoryData object, {
  ...
  void _deserializeProperties(
    ...
    required ListAccountSecurityStateHistoryDataBuilder result,
  ...
  @override
  ListAccountSecurityStateHistoryData deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ListAccountSecurityStateHistoryDataBuilder();
