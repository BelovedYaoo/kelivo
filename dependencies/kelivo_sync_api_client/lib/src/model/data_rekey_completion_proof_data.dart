...
abstract class DataRekeyCompletionProofData
  ...
  @BuiltValueField(wireName: r'proofFrame')
  String get proofFrame;

  @BuiltValueField(wireName: r'proofDigest')
  String get proofDigest;
