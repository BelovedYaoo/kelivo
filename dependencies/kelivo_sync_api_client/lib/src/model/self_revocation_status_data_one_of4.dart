...
part 'self_revocation_status_data_one_of4.g.dart';
...
/// * [receiptExpiresAt]
@BuiltValue()
abstract class SelfRevocationStatusDataOneOf4
    implements
        Built<
          SelfRevocationStatusDataOneOf4,
  ...
  SelfRevocationStatusDataOneOf4StatusEnum get status;
  // enum statusEnum {  superseded,  };
  ...
  SelfRevocationStatusDataOneOf4._();

  factory SelfRevocationStatusDataOneOf4([
    void updates(SelfRevocationStatusDataOneOf4Builder b),
  ]) = _$SelfRevocationStatusDataOneOf4;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SelfRevocationStatusDataOneOf4Builder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SelfRevocationStatusDataOneOf4> get serializer =>
      _$SelfRevocationStatusDataOneOf4Serializer();
}

class _$SelfRevocationStatusDataOneOf4Serializer
    implements PrimitiveSerializer<SelfRevocationStatusDataOneOf4> {
  @override
  ...
  @override
  final String wireName = r'SelfRevocationStatusDataOneOf4';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    SelfRevocationStatusDataOneOf4 object, {
    FullType specifiedType = FullType.unspecified,
  }) sync* {
    yield r'status';
    yield serializers.serialize(
      object.status,
      specifiedType: const FullType(SelfRevocationStatusDataOneOf4StatusEnum),
    );
    yield r'deviceId';
    yield serializers.serialize(
      object.deviceId,
  ...
  void _deserializeProperties(
    ...
    required SelfRevocationStatusDataOneOf4Builder result,
        ...
        case r'status':
          final valueDes =
              serializers.deserialize(
                  ...
                  as SelfRevocationStatusDataOneOf4StatusEnum;
  ...
  @override
  SelfRevocationStatusDataOneOf4 deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SelfRevocationStatusDataOneOf4Builder();
...
class SelfRevocationStatusDataOneOf4StatusEnum extends EnumClass {
  @BuiltValueEnumConst(wireName: r'superseded')
  static const SelfRevocationStatusDataOneOf4StatusEnum superseded =
      _$selfRevocationStatusDataOneOf4StatusEnum_superseded;

  static Serializer<SelfRevocationStatusDataOneOf4StatusEnum> get serializer =>
      _$selfRevocationStatusDataOneOf4StatusEnumSerializer;

  const SelfRevocationStatusDataOneOf4StatusEnum._(String name) : super(name);

  static BuiltSet<SelfRevocationStatusDataOneOf4StatusEnum> get values =>
      _$selfRevocationStatusDataOneOf4StatusEnumValues;
  static SelfRevocationStatusDataOneOf4StatusEnum valueOf(String name) =>
      _$selfRevocationStatusDataOneOf4StatusEnumValueOf(name);
}
