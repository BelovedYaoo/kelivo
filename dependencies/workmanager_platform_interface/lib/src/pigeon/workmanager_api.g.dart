...
abstract class WorkmanagerFlutterApi {
  ...
  Future<void> taskCancelled(String taskName);
  ...
  static void setUp(WorkmanagerFlutterApi? api, {BinaryMessenger? binaryMessenger, String messageChannelSuffix = '',}) {
    ...
    {
      final pigeonVar_channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.workmanager_platform_interface.WorkmanagerFlutterApi.taskCancelled$messageChannelSuffix', pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        pigeonVar_channel.setMessageHandler(null);
      } else {
        pigeonVar_channel.setMessageHandler((Object? message) async {
          ...
          final String arg_taskName = args[0]! as String;
          try {
            await api.taskCancelled(arg_taskName);
            return wrapResponse(empty: true);
          } on PlatformException catch (e) {
            return wrapResponse(error: e);
          }          catch (e) {
