...
abstract class AppLocalizations {
  ...
  /// No description provided for @cloudSyncWorkspaceRestartTitle.
  ///
  /// In en, this message translates to:
  /// **'Restart to Switch Workspaces'**
  String get cloudSyncWorkspaceRestartTitle;
  ...
  /// No description provided for @cloudSyncStatusWorkspaceChangePending.
  ///
  /// In en, this message translates to:
  /// **'Restart Required'**
  String get cloudSyncStatusWorkspaceChangePending;
