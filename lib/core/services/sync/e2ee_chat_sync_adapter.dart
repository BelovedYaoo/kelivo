      ...
      'attachments': <Object?>[
        for (var index = 0; index < message.attachments.length; index++)
          <String, Object?>{
            ...
            'chunkKeyEpoch': message.attachments[index].chunkKeyEpoch!,
            'manifestKeyEpoch': message.attachments[index].manifestKeyEpoch!,
            'manifestRevision': message.attachments[index].manifestRevision!,
