...
final class RestoreCutoverExecutor {
  ...
  /// 在终态运行的证据离开活动准入区前再次收敛它。
  /// 已提交运行绝不会在此回滚：任何无法解释的偏差都保持失败关闭。
  /// 已回滚运行可以重复其幂等反向移动，避免终态屏障中断后暴露混合状态。
