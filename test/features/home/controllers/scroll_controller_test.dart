...
void main() {
  ...
  group('ChatScrollController message navigation', () {
    ...
    testWidgets('streaming previous navigation disables bottom follow first', (
      ...
      messages.add(_navMessage(id: 'message-40', role: 'assistant'));
      await tester.pumpWidget(
        _IndexedScrollHarness(
          scrollController: scrollController,
          listController: chatScrollController.messageListController,
...
ChatMessage _navMessage({required String id, required String role}) {
  return ChatMessage(
    id: id,
    role: role,
    content: '',
    conversationId: 'scroll-controller-test',
  );
}
