...
class E2eeDataRekeyOperationRows extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  E2eeDataRekeyOperationRows(this.attachedDatabase, [this._alias]);
  ...
  @override
  E2eeDataRekeyOperationRows createAlias(String alias) {
    return E2eeDataRekeyOperationRows(attachedDatabase, alias);
  }
  ...
  List<String> get customConstraints => const [
    ...
    'UNIQUE(operation_id)',
    'UNIQUE(lease_token)',
    'UNIQUE(lease_mutation_id)',
    'CHECK(typeof(singleton) = \'integer\' AND singleton = 1)',
    'CHECK(typeof(user_id) = \'text\' AND length(user_id) = 36 AND user_id = lower(user_id) AND user_id NOT GLOB \'*[^0-9a-f-]*\' AND substr(user_id, 9, 1) = \'-\' AND substr(user_id, 14, 1) = \'-\' AND substr(user_id, 15, 1) = \'4\' AND substr(user_id, 19, 1) = \'-\' AND substr(user_id, 20, 1) IN (\'8\', \'9\', \'a\', \'b\') AND substr(user_id, 24, 1) = \'-\' AND substr(user_id, 1, 8) NOT GLOB \'*-*\' AND substr(user_id, 10, 4) NOT GLOB \'*-*\' AND substr(user_id, 15, 4) NOT GLOB \'*-*\' AND substr(user_id, 20, 4) NOT GLOB \'*-*\' AND substr(user_id, 25, 12) NOT GLOB \'*-*\')',
    'CHECK(typeof(issuer_device_id) = \'text\' AND length(issuer_device_id) = 36 AND issuer_device_id = lower(issuer_device_id) AND issuer_device_id NOT GLOB \'*[^0-9a-f-]*\' AND substr(issuer_device_id, 9, 1) = \'-\' AND substr(issuer_device_id, 14, 1) = \'-\' AND substr(issuer_device_id, 15, 1) = \'4\' AND substr(issuer_device_id, 19, 1) = \'-\' AND substr(issuer_device_id, 20, 1) IN (\'8\', \'9\', \'a\', \'b\') AND substr(issuer_device_id, 24, 1) = \'-\' AND substr(issuer_device_id, 1, 8) NOT GLOB \'*-*\' AND substr(issuer_device_id, 10, 4) NOT GLOB \'*-*\' AND substr(issuer_device_id, 15, 4) NOT GLOB \'*-*\' AND substr(issuer_device_id, 20, 4) NOT GLOB \'*-*\' AND substr(issuer_device_id, 25, 12) NOT GLOB \'*-*\')',
    'CHECK(typeof(operation_id) = \'text\' AND length(operation_id) = 36 AND operation_id = lower(operation_id) AND operation_id NOT GLOB \'*[^0-9a-f-]*\' AND substr(operation_id, 9, 1) = \'-\' AND substr(operation_id, 14, 1) = \'-\' AND substr(operation_id, 15, 1) = \'4\' AND substr(operation_id, 19, 1) = \'-\' AND substr(operation_id, 20, 1) IN (\'8\', \'9\', \'a\', \'b\') AND substr(operation_id, 24, 1) = \'-\' AND substr(operation_id, 1, 8) NOT GLOB \'*-*\' AND substr(operation_id, 10, 4) NOT GLOB \'*-*\' AND substr(operation_id, 15, 4) NOT GLOB \'*-*\' AND substr(operation_id, 20, 4) NOT GLOB \'*-*\' AND substr(operation_id, 25, 12) NOT GLOB \'*-*\')',
    'CHECK(typeof(lease_token) = \'text\' AND length(lease_token) = 36 AND lease_token = lower(lease_token) AND lease_token NOT GLOB \'*[^0-9a-f-]*\' AND substr(lease_token, 9, 1) = \'-\' AND substr(lease_token, 14, 1) = \'-\' AND substr(lease_token, 15, 1) = \'4\' AND substr(lease_token, 19, 1) = \'-\' AND substr(lease_token, 20, 1) IN (\'8\', \'9\', \'a\', \'b\') AND substr(lease_token, 24, 1) = \'-\' AND substr(lease_token, 1, 8) NOT GLOB \'*-*\' AND substr(lease_token, 10, 4) NOT GLOB \'*-*\' AND substr(lease_token, 15, 4) NOT GLOB \'*-*\' AND substr(lease_token, 20, 4) NOT GLOB \'*-*\' AND substr(lease_token, 25, 12) NOT GLOB \'*-*\')',
    'CHECK(typeof(lease_mutation_id) = \'text\' AND length(lease_mutation_id) = 36 AND lease_mutation_id = lower(lease_mutation_id) AND lease_mutation_id NOT GLOB \'*[^0-9a-f-]*\' AND substr(lease_mutation_id, 9, 1) = \'-\' AND substr(lease_mutation_id, 14, 1) = \'-\' AND substr(lease_mutation_id, 15, 1) = \'4\' AND substr(lease_mutation_id, 19, 1) = \'-\' AND substr(lease_mutation_id, 20, 1) IN (\'8\', \'9\', \'a\', \'b\') AND substr(lease_mutation_id, 24, 1) = \'-\' AND substr(lease_mutation_id, 1, 8) NOT GLOB \'*-*\' AND substr(lease_mutation_id, 10, 4) NOT GLOB \'*-*\' AND substr(lease_mutation_id, 15, 4) NOT GLOB \'*-*\' AND substr(lease_mutation_id, 20, 4) NOT GLOB \'*-*\' AND substr(lease_mutation_id, 25, 12) NOT GLOB \'*-*\')',
    'CHECK(lease_token <> lease_mutation_id)',
    'CHECK(typeof(source_data_generation) = \'integer\' AND source_data_generation BETWEEN 1 AND 2147483646)',
    'CHECK(typeof(source_key_epoch) = \'integer\' AND source_key_epoch BETWEEN 1 AND 4294967294)',
    'CHECK(typeof(target_key_epoch) = \'integer\' AND target_key_epoch = source_key_epoch + 1 AND target_key_epoch BETWEEN 2 AND 4294967295)',
    'CHECK(typeof(source_record_count) = \'integer\' AND source_record_count BETWEEN 0 AND 2147483647)',
    'CHECK(typeof(source_attachment_count) = \'integer\' AND source_attachment_count BETWEEN 0 AND 2147483647)',
    'CHECK(typeof(source_maximum_change_seq) = \'integer\' AND source_maximum_change_seq BETWEEN 0 AND 9007199254740991)',
    'CHECK((source_record_count = 0 AND source_record_cursor_end IS NULL)OR(source_record_count > 0 AND source_record_cursor_end IS NOT NULL))',
    'CHECK((source_attachment_count = 0 AND source_attachment_id_end IS NULL AND source_attachment_upload_id_end IS NULL)OR(source_attachment_count > 0 AND source_attachment_id_end IS NOT NULL AND source_attachment_upload_id_end IS NOT NULL))',
    'CHECK(source_record_cursor_end IS NULL OR(typeof(source_record_cursor_end) = \'text\' AND length(source_record_cursor_end) = 36 AND source_record_cursor_end = lower(source_record_cursor_end) AND source_record_cursor_end NOT GLOB \'*[^0-9a-f-]*\' AND substr(source_record_cursor_end, 9, 1) = \'-\' AND substr(source_record_cursor_end, 14, 1) = \'-\' AND substr(source_record_cursor_end, 15, 1) = \'4\' AND substr(source_record_cursor_end, 19, 1) = \'-\' AND substr(source_record_cursor_end, 20, 1) IN (\'8\', \'9\', \'a\', \'b\') AND substr(source_record_cursor_end, 24, 1) = \'-\' AND substr(source_record_cursor_end, 1, 8) NOT GLOB \'*-*\' AND substr(source_record_cursor_end, 10, 4) NOT GLOB \'*-*\' AND substr(source_record_cursor_end, 15, 4) NOT GLOB \'*-*\' AND substr(source_record_cursor_end, 20, 4) NOT GLOB \'*-*\' AND substr(source_record_cursor_end, 25, 12) NOT GLOB \'*-*\'))',
    'CHECK(source_attachment_id_end IS NULL OR(typeof(source_attachment_id_end) = \'text\' AND length(source_attachment_id_end) = 36 AND source_attachment_id_end = lower(source_attachment_id_end) AND source_attachment_id_end NOT GLOB \'*[^0-9a-f-]*\' AND substr(source_attachment_id_end, 9, 1) = \'-\' AND substr(source_attachment_id_end, 14, 1) = \'-\' AND substr(source_attachment_id_end, 15, 1) = \'4\' AND substr(source_attachment_id_end, 19, 1) = \'-\' AND substr(source_attachment_id_end, 20, 1) IN (\'8\', \'9\', \'a\', \'b\') AND substr(source_attachment_id_end, 24, 1) = \'-\' AND substr(source_attachment_id_end, 1, 8) NOT GLOB \'*-*\' AND substr(source_attachment_id_end, 10, 4) NOT GLOB \'*-*\' AND substr(source_attachment_id_end, 15, 4) NOT GLOB \'*-*\' AND substr(source_attachment_id_end, 20, 4) NOT GLOB \'*-*\' AND substr(source_attachment_id_end, 25, 12) NOT GLOB \'*-*\'))',
    'CHECK(source_attachment_upload_id_end IS NULL OR(typeof(source_attachment_upload_id_end) = \'text\' AND length(source_attachment_upload_id_end) = 36 AND source_attachment_upload_id_end = lower(source_attachment_upload_id_end) AND source_attachment_upload_id_end NOT GLOB \'*[^0-9a-f-]*\' AND substr(source_attachment_upload_id_end, 9, 1) = \'-\' AND substr(source_attachment_upload_id_end, 14, 1) = \'-\' AND substr(source_attachment_upload_id_end, 15, 1) = \'4\' AND substr(source_attachment_upload_id_end, 19, 1) = \'-\' AND substr(source_attachment_upload_id_end, 20, 1) IN (\'8\', \'9\', \'a\', \'b\') AND substr(source_attachment_upload_id_end, 24, 1) = \'-\' AND substr(source_attachment_upload_id_end, 1, 8) NOT GLOB \'*-*\' AND substr(source_attachment_upload_id_end, 10, 4) NOT GLOB \'*-*\' AND substr(source_attachment_upload_id_end, 15, 4) NOT GLOB \'*-*\' AND substr(source_attachment_upload_id_end, 20, 4) NOT GLOB \'*-*\' AND substr(source_attachment_upload_id_end, 25, 12) NOT GLOB \'*-*\'))',
    'CHECK(typeof(membership_generation) = \'integer\' AND membership_generation BETWEEN 1 AND 2147483647)',
    'CHECK(typeof(membership_manifest_digest) = \'blob\' AND length(membership_manifest_digest) = 32)',
    'CHECK(typeof(phase) = \'text\' AND phase IN (\'claim-pending\', \'leased\', \'scanning\', \'staging\', \'finalizing\'))',
    'CHECK((phase = \'claim-pending\' AND lease_version IS NULL AND lease_expires_at IS NULL)OR(phase != \'claim-pending\' AND typeof(lease_version) = \'integer\' AND lease_version BETWEEN 1 AND 2147483647 AND typeof(lease_expires_at) = \'integer\' AND lease_expires_at >= 0))',
    'CHECK(typeof(created_at) = \'integer\' AND created_at >= 0)',
    'CHECK(typeof(updated_at) = \'integer\' AND updated_at >= created_at)',
  ];
  @override
...
class E2eeConfigEntryRows extends Table with TableInfo {
  ...
  List<String> get customConstraints => const [
    ...
    'CHECK(entity_type != \'user-preference\' OR entity_id IN (\'profile:default\', \'provider-grouping:default\', \'assistant-selection:default\', \'world-book-activity:default\', \'instruction-activity:default\', \'search-state:default\', \'tts-state:default\', \'mcp-state:default\', \'generation-settings:default\'))',
  ];
  @override
  bool get dontWriteConstraints => true;
}
...
class E2eeAttachmentUploadRows extends Table with TableInfo {
  ...
  List<String> get customConstraints => const [
    ...
    'UNIQUE(target_config_entity_type, target_config_entity_id, target_config_slot)',
...
class DatabaseAtV27 extends GeneratedDatabase {
  DatabaseAtV27(QueryExecutor e) : super(e);
  ...
  late final E2eeDataRekeyOperationRows e2eeDataRekeyOperationRows =
      E2eeDataRekeyOperationRows(this);
